...
**Note:** This script is only guaranteed to work on nytimes.com, spellbee.org, spellsbee.net and spellsbee.com. Do not use this script if it violates the terms of service of the websites you run it on.
